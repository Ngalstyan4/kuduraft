...
class ConsensusServiceImpl : public consensus::ConsensusServiceIf {
 public:
  ...
  virtual void ChangeConfig(
      const consensus::ChangeConfigRequestPB* req,
      consensus::ChangeConfigResponsePB* resp,
      rpc::RpcContext* context) override;

  virtual void BulkChangeConfig(
      const consensus::BulkChangeConfigRequestPB* req,
      consensus::ChangeConfigResponsePB* resp,
      rpc::RpcContext* context) override;

  virtual void UnsafeChangeConfig(
      const consensus::UnsafeChangeConfigRequestPB* req,
      consensus::UnsafeChangeConfigResponsePB* resp,
      rpc::RpcContext* context) override;

  virtual void ChangeProxyTopology(
      const consensus::ChangeProxyTopologyRequestPB* req,
      consensus::ChangeProxyTopologyResponsePB* resp,
      rpc::RpcContext* context) override;

  virtual void GetNodeInstance(
      const consensus::GetNodeInstanceRequestPB* req,
      consensus::GetNodeInstanceResponsePB* resp,
      rpc::RpcContext* context) override;

  virtual void RunLeaderElection(
      const consensus::RunLeaderElectionRequestPB* req,
      consensus::RunLeaderElectionResponsePB* resp,
      rpc::RpcContext* context) override;

  virtual void LeaderStepDown(
      const consensus::LeaderStepDownRequestPB* req,
