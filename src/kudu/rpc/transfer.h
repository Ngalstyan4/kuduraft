...
// to encompass it. This sits on a queue within the Connection, so that each
// time the Connection wakes up with a writable socket, it consumes more bytes
// off the next pending transfer in the queue.
//
